...
public abstract class AbstractApiController {
  ...
  protected ResponseEntity<ApiResponseBase> sendResponseUserPublic(User user,
      Integer certificateProgress, Locale locale) {
    return sendResponseOk(
        new ApiResponseUserPublic(new ApiUserPublic(user, certificateProgress), locale));
  }

...
public class StorageService {
  ...
  public String uploadCertificateToStorage(String fileName, InputStream inputCertificate) throws IOException {
    String filePath =  GCS_FOLDER_USER_CERTIFICATE + "/" + fileName;

    GcsFileOptions instance = GcsFileOptions.getDefaultInstance();
    GcsFilename gscFileName = new GcsFilename(GCS_BUCKET, filePath);
    GcsOutputChannel outputChannel;
    outputChannel = gcsService.createOrReplace(gscFileName, instance);

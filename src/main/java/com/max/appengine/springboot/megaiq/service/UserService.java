...
public class UserService {
  ...
  public List<User> getUsersListTopMonth(Locale locale, Optional<Integer> page) {
    ...
    return loadUsersByPeriod(locale, 360*2, PageRequest.of(currentPage, LIMIT_LIST_PAGE));
  }
  ...
  public List<User> getLastProfiles(Locale locale) {
    return userReporitory.findTop12ByLocaleAndIsPublicIsTrueOrderByCreateDateDesc(locale);
  }
